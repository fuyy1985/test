...
-(NSMutableArray *)getCodeIDOfCityByName:(NSString *)key{
	...
	NSMutableArray *codeid=[[[NSMutableArray alloc] init] autorelease];
...
/*
//obtain all city of qiantangjiang river
-(NSArray *)getCityByProvice:(NSString *)key{
	sqlite3 *db;
	sqlite3_stmt *stmt;
	const char *sql="select pac, pacname from area where pac like ? and pac not like '%%0000' and pac not in ('330300','330900','331000','331100') ";
	NSString *path=[self getDBPath];
	NSMutableArray *pks=[NSMutableArray array];
